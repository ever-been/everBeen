...
public class ResubmitActionConfiguration extends BeenServiceConfiguration {
	...
	/** The maximum number of benchmark generator resubmits before aborting the whole benchmark. */
	public static final String MAXIMUM_ALLOWED_RESUBMITS = "been.cluster.resubmit.maximum-allowed";
	/** The default maximum number of resubmits is '{@value #DEFAULT_MAXIMUM_ALLOWED_RESUBMITS}'. */
