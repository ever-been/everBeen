...
public class SRClientTestApp {
	...
	@Option(name = "-d", aliases = { "--dir" }, usage = "Software repository cache directory")
	private File persistenceRootDir = new File("/tmp");
	...
	private void doMain(String[] args) {
		...
		SwRepoClient client = new SwRepoClientFactory(persistenceRootDir).getClient(host, port);
