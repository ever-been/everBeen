...
/**
 * This remote object provides access to some external features this service
 * will expose.
 * 
 * @author Andrej Podzimek
 */
public class CommandLineImplementation extends UnicastRemoteObject implements
	...
	/**
	 * This creates a new remote object for this service and spawns a new
	 * instance of its thread factory. Say WOW!
	 * 
	 * @throws IOException
	...
	public void flushPool(String name) {
		CurrentTaskSingleton.getTaskHandle().logInfo(
				"Instance pool flush requested for: " + name);
