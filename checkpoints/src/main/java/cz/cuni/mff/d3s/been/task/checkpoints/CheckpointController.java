 ...
 * <p/>
 * The CheckpointController provides checkpoint REQ-REP semantics for tasks. Requests are handled by
...
public class CheckpointController {
    ...
    /**
     * Creates a new CheckpointController. Each thread must create its own CheckpointController, the
     ...
     *
     * @param checkPointName name of the check point to set
     * @param value          value of the check point
     ...
     *
     * @param name name of the check point
     ...
     * @return value of the check point
     * @throws RequestException when the request fails
     * @throws TimeoutException when the request timeouts
     */
