...
/*! \file FedoraCoreDistribution.h
 *  \author Branislav Repcek
 *  \date 15. 12. 2006
 *
 *  \brief Header file for Fedora Core distribution handler.
 */

#ifndef FEDORA_CORE_DISTRIBUTION_INCLUDED
#define FEDORA_CORE_DISTRIBUTION_INCLUDED
...
namespace hwdet
{
    /*! \brief Custom handler for Fedora Core distros.
     */
    class FedoraCoreDistribution : public Distribution
    {
    public:
