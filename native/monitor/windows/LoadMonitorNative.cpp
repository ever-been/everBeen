 ...
 *  \date 2. 10. 2006
 *
 *  \brief Definitions of methods exported from DLL.
 */
...
{
    COMPILE_TIME_CHECK(sizeof(jint) == sizeof(__int32), Invalid_integer_type_size);
    COMPILE_TIME_CHECK(sizeof(jlong) == sizeof(__int64), Invalid_long_type_size);
    COMPILE_TIME_CHECK(sizeof(jshort) == sizeof(__int16), Invalid_short_type_size);
