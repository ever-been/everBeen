...
public class DoesNotMatchConditionTest {
	...
	@Test
	public void testStringPatternCaseSensitiveFalse() throws ParseException, RSLSemanticException {
		assertFalse(Utils.eval("stringForPatternProperty !~ /StRiNg/", context));
	}

	@Test
	public void testStringPatternCaseSensitiveTrue1() throws ParseException, RSLSemanticException {
		assertTrue(Utils.eval("stringForPatternProperty !~ /STRING/", context));
	}
	
	@Test
	public void testStringPatternCaseSensitiveTrue2() throws ParseException, RSLSemanticException {
		assertTrue(Utils.eval("stringForPatternProperty !~ /string/", context));
	}

	@Test
	public void testStringPatternCaseSensitiveTrue3() throws ParseException, RSLSemanticException {
		assertTrue(Utils.eval("stringForPatternProperty !~ /no-match/", context));
	}

	@Test
	public void testStringPatternCaseInsensitiveFalse1() throws ParseException, RSLSemanticException {
		assertFalse(Utils.eval("stringForPatternProperty !~ /StRiNg/i", context));
	}

	@Test
	public void testStringPatternCaseInsensitiveFalse2() throws ParseException, RSLSemanticException {
		assertFalse(Utils.eval("stringForPatternProperty !~ /STRING/i", context));
	}
	
	@Test
	public void testStringPatternCaseInsensitiveFalse3() throws ParseException, RSLSemanticException {
		assertFalse(Utils.eval("stringForPatternProperty !~ /string/i", context));
	}

	@Test
	public void testStringPatternCaseInsensitiveTrue() throws ParseException, RSLSemanticException {
