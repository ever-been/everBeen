 ...
 * @author David Majda
 */
public class NotEqualCondition<T> extends SimpleCondition<T> {

	private static final long	serialVersionUID	= 9192884967460127879L;

	/**
	 * Allocates a new <code>NotEqualCondition</code> object.
	 * 
	 * @param propertyPath property path
	 * @param value value to compare
	 */
	public NotEqualCondition(String propertyPath, T value) {
