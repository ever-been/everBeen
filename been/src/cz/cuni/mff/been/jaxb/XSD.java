...
public enum XSD {
	...
	BENCHMARK(
		"http://been.mff.cuni.cz/benchmarkmanagerng/benchmark",
		XSDFile.COMMON.FILE,
	...
	CONFIG(
		"http://been.mff.cuni.cz/benchmarkmanagerng/config",
		XSDFile.COMMON.FILE,
		//XSDFile.ATTRTYPES.FILE,
		XSDFile.CONFIG.FILE
	),
	...
	CONDITION(
		"http://been.mff.cuni.cz/taskmanager/td",
		XSDFile.COMMON.FILE,
		//XSDFile.STRBIN.FILE,
	...
	DATASET(
		"http://been.mff.cuni.cz/resultsrepositoryng/dataset",
		XSDFile.COMMON.FILE,
		//XSDFile.ATTRTYPES.FILE,
	...
	GROUP(
		"http://been.mff.cuni.cz/hostmanager/group",
		XSDFile.COMMON.FILE,
		//XSDFile.ATTRTYPES.FILE,
		XSDFile.GROUP.FILE
	),
	...
	PMC(
		"http://been.mff.cuni.cz/pluggablemodule/pmc",
		XSDFile.COMMON.FILE,
		XSDFile.PMC.FILE
	),
	...
	PROPERTIES(
		"http://been.mff.cuni.cz/hostmanager/properties",
		XSDFile.COMMON.FILE,
		//XSDFile.ATTRTYPES.FILE,
		XSDFile.PROPERTIES.FILE
	),
	
	/** Task Descriptor representation. */
	TD(
		"http://been.mff.cuni.cz/taskmanager/td",
		XSDFile.COMMON.FILE,
		//XSDFile.STRBIN.FILE,
	...
	TUPLIT(
		"http://been.mff.cuni.cz/resultsrepositoryng/tuplit",
		XSDFile.COMMON.FILE,
		//XSDFile.ATTRTYPES.FILE,
		XSDFile.TUPLIT.FILE
	);
	...
	private abstract class FilesContainer {
		 ...
		 * 
		 * @throws SAXException When the low level SAX parser fails.
		 */
	 ...
	 * @param prefix The usual XML prefix used (by convention) for the namespace.
	 ...
	 * @throws SAXException When a low-level SAX parser failure occurs.
	 * @throws JAXBException When the JAXB class is refused.
	 */
