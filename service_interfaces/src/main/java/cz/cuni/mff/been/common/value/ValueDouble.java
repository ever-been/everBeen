...
/**
 * Class representing floating-point numbers in the range of the built-in java
 * double.
 * 
 * @author Branislav Repcek
 */
public class ValueDouble implements Serializable, XMLSerializableInterface,
		ValueBasicInterface<ValueDouble> {
	 ...
	 *            New value.
	 * @param unit
	 *            Unit of measure for given value.
	 */
	 ...
	 * 
	 * @param v
	 *            <code>ValueInteger</code> which will be used to initialize
	 *            this.
	 */
	 ...
	 *             If there was and error while parsing XML node data.
	 */
	...
	/**
	 * Test for equality. This test may not be accurate for floating-point
	 * numbers.
	 * 
	 * @param d
	 *            Number to test against.
	 ...
	 *            Number to test against.
	 * @param epsilon
	 *            Maximum distance numbers are allowed to be apart to pass the
	 *            test.
	 * 
	 * @return <code>true</code> if argument lies in the open interval
	 *         (this-epsilon, this+epsilon), <code>false</code> otherwise.
	 */
	 ...
	 * @param d
	 *            Object to test.
	 * @return <code>true</code> if current object is less than <code>d</code>,
	 *         <code>false</code> otherwise.
	 */
	 ...
	 *         <code>d</code>, <code>false</code> otherwise.
	 */
	...
	public void parseXMLNode(Node node) throws InputParseException {
		...
		if (!node.getNodeName().equals(getXMLNodeName())) {
			throw new InputParseException(
					"Node does not contain double data. Node name is \""
							+ node.getNodeName() + "\".");
		}

		value = Double
				.valueOf(XMLHelper.getAttributeValueByName("value", node))
				.doubleValue();
	}
