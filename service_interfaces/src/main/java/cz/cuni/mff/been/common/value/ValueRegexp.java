 ...
 * 
 */
public class ValueRegexp implements ValueBasicInterface<ValueRegexp>,
	 ...
	 * 
	 * @param newValue
	 *            Regular expression string. For more info on format @see <a
	 *            href=
	 *            "http://java.sun.com/j2se/1.4.2/docs/api/java/util/regex/Pattern.html"
	 *            >java.util.regex.Pattern</a>
	 * @param caseSense
	 *            If <code>true</code> regular expression will be case
	 *            sensitive.
	 * @throws PatternSyntaxException
	 *             If syntax of <code>newValue</code> is invalid.
	 */
	public ValueRegexp(String newValue, boolean caseSense)
			throws PatternSyntaxException {
	...
	/**
	 * Allocate new <code>ValueRegexp</code> value. This method is same as
	 * <code>ValueRegexp(String, boolean)</code>, except it always creates case
	 ...
	 * 
	 * @param pattern
	 *            The pattern this regexp will match.
	 */
	 ...
	 * @param str
	 *            String to test.
	 * @return <code>true</code> if string matches current regular expression,
	...
	public void parseXMLNode(Node node) throws InputParseException {
		...
		if (!node.getNodeName().equals(getXMLNodeName())) {
			throw new InputParseException(
					"Node does not contain regexp data. Node name is \""
							+ node.getNodeName() + "\".");
		}

		value = XMLHelper.getAttributeValueByName("value", node);
		caseSensitive = XMLHelper.getAttributeValueByName("caseSense", node)
				.equals("yes");
	...
	public Element exportAsElement(Document document) {
		 ...
		 * 
		 * where <case-sense> is either "yes" or "no" depending on the case
		 * sensitivity of the regexp.
		 */
	 ...
	 * 
	 * @return <code>true</code> if regular expression if case sensitive,
	 *         <code>false</code> otherwise.
	 */
	 ...
	 * 
	 * @param caseSensitive
	 *            If set to <code>true</code> expression will be case sensitive,
	 *            otherwise is is case insensitive.
	 */
	public void setCaseSensitive(boolean caseSensitive) {
		...
		try {
			...
			// this should never happen since we already compiled given
			// expression before
	 ...
	 * 
	 * @throws PatternSyntaxException
	 *             If given regular expression is invalid.
	 */
