 ...
 */
public class ValueBoolean implements ValueBasicInterface<ValueBoolean>,
	 ...
	 * @param b
	 *            Object to test.
	 * @return <code>true</code> if current object is less than <code>b</code>,
	 *         <code>false</code> otherwise. Note that <code>true</code> is
	 *         greater than <code>false</code>.
	 */
	 ...
	 *         <code>false</code> otherwise. Note that <code>false</code> is
	...
	public void parseXMLNode(Node node) throws InputParseException {
		...
		if (!node.getNodeName().equals(getXMLNodeName())) {
			throw new InputParseException(
					"Node does not contain boolean data. Node name is \""
							+ node.getNodeName() + "\".");
		}
	...
	/**
	 * @param value
	 *            New value that will be stored in this object.
	 */
