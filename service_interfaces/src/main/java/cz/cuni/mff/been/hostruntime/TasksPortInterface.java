...
public interface TasksPortInterface extends Remote {
	/**
	 * Returns the task directory, which would specified task have, if it was
	...
	/**
	 * Returns the temporary directory, which would specified task have, if it
	 ...
	 * @throws RemoteException
	 *             if something failes during the execution of the remote method
	 *             call
	 */
	 ...
	 *            task descriptor of the new task
	 * @throws RemoteException
	 *             if something fails during the execution of the remote method
	 *             call.
	 */
	 ...
	 *            task descriptors of the new tasks
	 * @throws RemoteException
	 *             if something fails during the execution of the remote method
	 *             call.
	 */
	 ...
	 * @param message
	 *            the log message; can be multiline; cannot be null or contain
	 *            "\t\t\t".
	 * @throws RemoteException
	 *             if something fails during the execution of the remote method
	 *             call.
	 ...
	 * 
	 * @param context
	 *            task's context; cannot be <code>null</code> or an empty string
	 * @param taskID
	 *            task's ID; cannot be <code>null</code> or an empty string
	 ...
	 *             call.
	 */
	void checkPointReached(String name, Serializable value)
			throws RemoteException;
	 ...
	 * 
	 * @param contextID
	 *            context ID; if <code>null</code> then the context of the
	 ...
	 *            checkpoint name
	 * @param timeout
	 *            number of miliseconds to wait for a checkpoint; <code>0</code>
	 *            means that the call will not block and returns immediately
	 * 
	...
	/**
	 * Unregisters all services matching the service template form the Task
	 * Manager.
	 * 
	 * @param serviceTemplate
	 *            template of services to remove
	 * @throws RemoteException
	 *             if something fails during the execution of the remote method
	 *             call.
	 */
	 ...
	 *             call.
	 * @throws IllegalArgumentException
	 *             when task does not exist in task manager
	 */
	TaskEntry getTaskById(String taskId, String contextId)
			throws RemoteException, IllegalArgumentException;

	/**
	 * Tells to hostruntime's package cache manager to extract package of given
	 * type with given name and version to a specified path
	 * 
	 * @param packageName
	 *            package name
