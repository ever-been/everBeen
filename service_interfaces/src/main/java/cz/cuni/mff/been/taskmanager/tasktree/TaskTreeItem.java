...
interface TaskTreeItem extends Serializable {
	...
	/**
	 * A list of possible tree item types. Currently, only internal nodes and
	 * leaves are supported.
	 */
	public enum Type {

		/**
		 * Internal node of the tree. It may contain leaves and subnodes in
		 * arbitrary order.
		 */
		NODE,
	 ...
	 * Address getter.
	 * 
	 * @return A reference to the one and only instance of TaskTreeAddress
	 *         representing this tree item's position in the tree.
	 */
	 ...
	 * 
	 * @return A reference to the one and only instance of TaskTreeAddress
	 *         pointing at this item's parent node.
	 */
	 ...
	 *             When called on a leaf.
	 */
	Collection<TaskTreeAddressBody> getChildren()
			throws IllegalAddressException;
	 ...
	 * @throws IllegalAddressException
	 *             When called on an internal node.
	 */
