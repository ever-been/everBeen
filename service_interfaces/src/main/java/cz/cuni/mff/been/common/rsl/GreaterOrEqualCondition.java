 ...
 * @author David Majda
 */
public class GreaterOrEqualCondition<T> extends CompareCondition<T> {

	private static final long	serialVersionUID	= -7424651178923005747L;

	/**
	 * Allocates a new <code>GreaterOrEqualCondition</code> object.
	 * 
	 * @param propertyPath property path
	 * @param value value to compare
	 */
	public GreaterOrEqualCondition(String propertyPath, T value) {
