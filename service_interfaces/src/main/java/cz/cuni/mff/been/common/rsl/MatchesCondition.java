 ...
 * @author David Majda
 */
public class MatchesCondition<T> extends PatternCondition<T> {

	private static final long	serialVersionUID	= 7240245789058833865L;

	/**
	 * Allocates a new <code>MatchesCondition</code> object.
	 * 
	 * @param propertyPath property path
	 * @param value regular expression to match against
	 */
	public MatchesCondition(String propertyPath, T value) {
