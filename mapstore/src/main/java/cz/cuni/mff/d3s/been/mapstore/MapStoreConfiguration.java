...
public class MapStoreConfiguration implements BeenServiceConfiguration {
	 ...
	 * <code>com.hazelcast.core.MapStore</code> connection
	 */
	...
	/**
	 * Property name for the <code>com.hazelcast.core.MapStore</code> hostname
	 * (full connection string including port). If no port is specified, default
	 * port is used.
	 */
	...
	/**
	 * Property name for the name of the <code>com.hazelcast.core.MapStore</code>
