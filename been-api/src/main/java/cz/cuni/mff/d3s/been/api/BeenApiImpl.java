...
public class BeenApiImpl implements BeenApi {
    ...
    @Override
    public Collection<ServiceLogMessage>
     ...
     *
     * @param query       {@link Query} you used to retrieve data. This method should only
     ...
     * @param errorMsg if the operation fails, message will be added to produced
     *                 exception
     * @throws ClusterConnectionUnavailableException
     *                              when been api is not connected to cluster
     * @throws PersistenceException when retrieved query answer is invalid or with status other than
     *                              OK
