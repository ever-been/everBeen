...
public class PersistenceJanitorConfiguration {
	...
	/** Number of hours that objects with a <code>failed</code> status stay persistent */
	...
	/** Number of hours that meta-info objects with a 'finished' status will stay persistent */
	public static final String FINISHED_LONGEVITY = "been.repository.janitor.finished-longevity";
	/** By default, meta-info of objects with a <code>finished</code> status will stay persistent for {@value #DEFAULT_FINISHED_LONGEVITY} hours */
	...
	/** By default, the persistence janitor will wake up every {@value #DEFAULT_WAKEUP_INTERVAL} minutes */
