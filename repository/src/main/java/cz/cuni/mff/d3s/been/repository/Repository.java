...
import static cz.cuni.mff.d3s.been.repository.RepositoryServiceInfoConstants.SERVICE_NAME;
...
public final class Repository implements IClusterService {
	...
	private Repository(ClusterContext ctx, Storage storage, String beenId) {
		this.ctx = ctx;
	 ...
	 */
	public static Repository create(ClusterContext ctx, Storage storage, String beenId) {
		return new Repository(ctx, storage, beenId);
	}
	...
	public void start() throws ServiceException {
		...
		info.setServiceInfo("Object repository running");
