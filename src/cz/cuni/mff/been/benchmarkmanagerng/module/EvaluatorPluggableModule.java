...
public abstract class EvaluatorPluggableModule extends PluggableModule
	...
	/* (non-Javadoc)
	 * @see cz.cuni.mff.been.benchmarkmanagerng.module.EvaluatorInterface#attachToAnalysis(java.lang.String, cz.cuni.mff.been.benchmarkmanagerng.Configuration)
	 */
	@Override
	public void attachToAnalysis( Analysis analysis, Configuration configuration ) throws RemoteException, ResultsRepositoryException {
	...
	/* (non-Javadoc)
	 * @see cz.cuni.mff.been.benchmarkmanagerng.module.EvaluatorInterface#detachFromAnalysis(java.lang.String)
	 */
	@Override
	public void detachFromAnalysis( Analysis analysis, Configuration configuration ) throws RemoteException, ResultsRepositoryException {
		this.analysis = analysis;
		this.configuration = configuration;
	 ...
	 * 
	 */
	protected abstract Map<String, DatasetDescriptor> doCreateDatasets(Configuration configuration) throws RemoteException, ResultsRepositoryException;

	/**
	 * 
	 */
	protected abstract List<RRTrigger> doCreateTriggers() throws RemoteException, ResultsRepositoryException;
	 ...
	 */
	protected final RRManagerInterface getRRManagerInterface() throws RemoteException {
	 ...
	 */
	protected final void deleteDatasets(String analysis, Map<String, DatasetDescriptor> datasets, Collection<String> createdDatasets)
	 ...
	 * @throws RemoteException 
	 */
	protected final void deleteTriggers(Collection<RRTrigger> triggers) throws RemoteException, ResultsRepositoryException {
		RRManagerInterface rr = getRRManagerInterface();
		for (RRTrigger trigger : triggers) {
			rr.deleteTriggers(trigger.getAnalysis(), trigger.getDataset(), trigger.getEvaluator());
		}
	}
