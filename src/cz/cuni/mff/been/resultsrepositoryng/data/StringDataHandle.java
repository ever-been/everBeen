...
/**
 * Data handle referencing directly accessible string data.
 * 
 * @author Jan Tattermusch
 *
 */
public class StringDataHandle extends DataHandle {

	private static final long serialVersionUID = 4571899411462547874L;
	private String data;
	
	public StringDataHandle(String data) {
		this.data = data;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		StringDataHandle other = (StringDataHandle) obj;
		if (data == null) {
			if (other.data != null)
				return false;
