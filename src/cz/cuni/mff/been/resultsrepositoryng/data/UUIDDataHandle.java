...
/**
 * Data handle referencing directly accessible UUID data.
 * 
 * @author Jan Tattermusch
 *
 */
public class UUIDDataHandle extends DataHandle {

	private static final long serialVersionUID = 45718234462547874L;
	private UUID data;
	
	public UUIDDataHandle(UUID data) {
		this.data = data;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		UUIDDataHandle other = (UUIDDataHandle) obj;
		if (data == null) {
			if (other.data != null)
				return false;
