...
public final class ResultsModule extends CommandLineModule {
	...
	public enum Errors implements Message {
		...
		INVD_PARAMS_TD( "Specify either 'uuid' xor ('analysis', 'dataset', 'evaluator')." ),
		...
		/** Trying to send an instance of a class with a non-public String constructor. */
		...
		MALF_TRIGGER( "Data stored, but an invalid trigger encountered. Details follow." ),
		...
		DEPD_NAMES_PLAIN( "The 'names' flag can only be used with the 'plain' flag." ),
		
		/** When uuid is not specified alone. */
		EXCL_UUID( "Parameters 'uuid' and ('analysis', 'dataset', 'evaluator') are exclusive." ),

		/** When Results Repository's remote reference reports a failure. */
		CONN_RRMI( "Could not contact the Results Repository's Manager Interface." ),
		...
		INTG_TYPE( "Integrity error. Data recovery failed due to a type mismatch." ),
		...
		INTG_COND( "Integrity error. JAXB classes and condition.xsd out of sync." ),

		/** When something bad happens to the JAXB parser. */
		INTG_TRIGGER( "Integrity error. JAXB classes and trigger.xsd out of sync." ),
	...
	static {
		...
		actions.put(
			"analysis-list",
			new CommandLineAction< ResultsModule >() {
				...
				public void handle(
					...
					try {
						if ( null == pattern ) {
							analyses = module.resultsRepositoryAdapter.getAnalyses();
						} else {
							analyses = module.resultsRepositoryAdapter.getAnalyses(
						...
						throw new ModuleSpecificException( Errors.CONN_RRMI, exception );
		...
		actions.put(
			"dataset-list",
			new CommandLineAction< ResultsModule >() {
				private final Set< String > allParameters = stringSet( "analysis", "pattern" );
				...
				public void handle(
					...
					try {
						if ( null == pattern ) {
							datasets = module.resultsRepositoryAdapter.getDatasets( analysis );
						} else {
						...
						throw new ModuleSpecificException( Errors.FAIL_RR, exception );				// No other reason to throw...
					} catch ( ComponentInitializationException exception ) {
						throw new ModuleSpecificException( Errors.CONN_RRMI, exception );
					} catch ( RemoteException exception ) {
						throw new ModuleSpecificException( Errors.CONN_RRMI, exception );
		...
		actions.put(
			"dataset-dump",
			new CommandLineAction< ResultsModule >() {
				private final Set< String > parameters = stringSet( "analysis", "dataset" );
				private final Set< String > flags = stringSet();
				...
				public void handle(
					...
					try {
						xdataset = module.resultsRepositoryAdapter.getDataset( analysis, dataset );
					} catch ( ResultsRepositoryException exception ) {								// TODO: Distinguish!!!
						throw new ModuleSpecificException(
							Errors.INVD_DATASET,
							" (" + analysis + ", " + dataset + ')',
							exception
						);																			// No other reason to throw...
					} catch ( ComponentInitializationException exception ) {
						throw new ModuleSpecificException( Errors.CONN_RRMI, exception );
					} catch ( RemoteException exception ) {
						throw new ModuleSpecificException( Errors.CONN_RRMI, exception );
		...
		actions.put(
			...
			new CommandLineAction< ResultsModule >() {
				...
				private final Set< String > requiredParameters = stringSet( "analysis", "dataset" );
				...
				public void handle(
					...
					if ( request.hasBlob() ) {
						try {
							condition = module.conditionParser.parse( request.getBlobStream() );
					...
					try {
						if ( plain ) {
							...
							tuples = module.resultsRepositoryAdapter.getDatasetRawData(
								analysis,
								dataset,
								condition,
								lfrom,
							...
							tupLit = module.resultsRepositoryAdapter.getDatasetData(				// Before stream instantiation!
								analysis,
								dataset,
								condition,
								lfrom,
						...
						throw new ModuleSpecificException(
							Errors.INVD_DATASET,													// Any other probable failures...?
							" (" + analysis + ", " + dataset + ')',
							exception
						);
					} catch ( ComponentInitializationException exception ) {
						throw new ModuleSpecificException( Errors.CONN_RRDI, exception );
					} catch ( RemoteException exception ) {
						throw new ModuleSpecificException( Errors.CONN_RRDI, exception );
					}
				}
		...
		actions.put(
			"dataset-store",
			new CommandLineAction< ResultsModule >() {
				private Set< String > parameters = stringSet( "analysis", "dataset" );
				private Set< String > flags = stringSet();
				...
				public void handle(
					...
					try {
						...
						throw new ModuleSpecificException( Errors.MALF_TRIGGER, exception );
					} catch ( ComponentInitializationException exception ) {
						throw new ModuleSpecificException( Errors.CONN_RRDI, exception );
					} catch ( RemoteException exception ) {
						throw new ModuleSpecificException( Errors.CONN_RRDI, exception );
		...
		actions.put(
			"dataset-create",
			new CommandLineAction< ResultsModule >() {
				private Set< String > parameters = stringSet();
				private Set< String > flags = stringSet();
				...
				public void handle(
					...
					Dataset dataset;
					try {
						dataset = module.datasetParser.parse( request.getBlobStream() );
					} catch ( UnmarshalException exception ) {
						throw new ModuleSpecificException( Errors.FAIL_UMSL_VAL, exception );
					} catch ( JAXBException exception ) {
						throw new ModuleSpecificException( Errors.FAIL_UMSL, exception );
					...
					try {
						...
						throw new ModuleSpecificException(
							Errors.INVD_DATASET,													// Any other probable failures...?
							" (" + dataset.getAnalysis() + ", " + dataset.getName() + ')',
							exception
						);
					} catch ( ComponentInitializationException exception ) {
						throw new ModuleSpecificException( Errors.CONN_RRMI, exception );
		...
		actions.put(
			...
			new CommandLineAction< ResultsModule >() {
				...
				public void handle(
					...
					try {
						module.resultsRepositoryAdapter.deleteDataset( analysis, dataset );
					} catch ( ResultsRepositoryException exception ) {								// TODO: Distinguish!!!
						throw new ModuleSpecificException(
							Errors.INVD_DATASET,													// Any other probable failures...?
							" (" + analysis + ", " + dataset + ')',
		...
		actions.put(
			"trigger-list",
			new CommandLineAction< ResultsModule >() {
				private Set< String > allParameters = stringSet( "analysis", "dataset", "pattern" );
				private Set< String > requiredParameters = stringSet( "analysis", "dataset" );
				private Set< String > flags = stringSet();
				private final String help = constructHelp(
					allParameters,
					flags,
		...
		actions.put(
			"trigger-dump",
			new CommandLineAction< ResultsModule >() {
				private Set< String > parameters = stringSet( "uuid" );
				private Set< String > flags = stringSet( "binary" );
				private final String help = constructHelp( parameters, flags, parameters, false );
		...
		actions.put(
			...
			new CommandLineAction< ResultsModule >() {
				...
				public void handle(
					...
					try {
						trigger = module.triggerParser.parse( request.getBlobStream() );
						response.sendOut(
							module.resultsRepositoryAdapter.createTrigger( trigger ).toString() +
							'\n'
						);
					} catch ( UnmarshalException exception ) {
						...
						exception.printStackTrace( System.err );
						throw new ModuleSpecificException( Errors.FAIL_UMSL, exception );
					} catch ( ResultsRepositoryException exception ) {								// This should be more detailed.
						throw new ModuleSpecificException( Errors.FAIL_RR, exception );
					} catch ( ComponentInitializationException exception ) {
						throw new ModuleSpecificException( Errors.CONN_RRMI, exception );
					} catch ( ConvertorException exception ) {
		...
		actions.put(
			"trigger-delete",
			new CommandLineAction< ResultsModule >() {
				private Set< String > uuidParameters = stringSet( "uuid" );
				private Set< String > idParameters = stringSet(
					"analysis",
					"dataset",
					"evaluator"
				);
				private Set< String > allParameters = new TreeSet< String >( idParameters );
				{
					allParameters.addAll( uuidParameters );
				}
				private Set< String > flags = stringSet();
				private final String help = constructHelp( allParameters, flags, false );
				...
				public void handle(
					...
					if ( null == uuid ) {
						...
						if ( null != errors ) {
							throw new ModuleSpecificException( Errors.INVD_PARAMS_TD, errors );
						}
						...
						try {
							module.
							resultsRepositoryAdapter.deleteTriggers( analysis, dataset, evaluator );
						} catch ( ResultsRepositoryException exception ) {							// TODO: Distinguish!!!
							throw new ModuleSpecificException(
								Errors.FAIL_TR_DEL,
								" (" + analysis + ", " + dataset + ", " + evaluator + ')',
								exception
							);
						} catch ( ComponentInitializationException exception ) {
							throw new ModuleSpecificException( Errors.CONN_RRMI, exception );
						...
						try {
							module.
							resultsRepositoryAdapter.deleteTrigger( UUID.fromString( uuid ) );
						} catch ( IllegalArgumentException exception ) {
							throw new ModuleSpecificException(
								Errors.MALF_UUID,
								" (" + uuid + ')',
				...
				public void handle(
					...
					try {
						response.sendOut(															// Write the UUID!
							module.resultsRepositoryAdapter
							.uploadFile( request.getBlobStream() )
							.toString() + '\n'
						);
					} catch ( ComponentInitializationException exception ) {
						throw new ModuleSpecificException( Errors.CONN_RRDI, exception );
					} catch ( IOException exception ) {												// A special meaning here.
						throw new ModuleSpecificException( Errors.FAIL_UPL, exception );
					}
				}
		...
		actions.put(
			...
			new CommandLineAction< ResultsModule >() {
				...
				public void handle(
					...
					try {
						module.resultsRepositoryAdapter.deleteFile( UUID.fromString( uuid ) );
					} catch ( IllegalArgumentException exception ) {
						throw new ModuleSpecificException(
							Errors.MALF_UUID,
							" (" + uuid + ")",
