...
public interface TaskManagerInterface extends Remote {
	...
	static final String SYSTEM_CONTEXT_DESCRIPTION
		= "Context for running system components of BEEN.";
	...
	static final long DEFAULT_MAX_PACKAGE_CACHE_SIZE = 1024 * 1024 * 1024; // 1 GB
	...
	static final int DEFAULT_LOAD_UNITS = new LoadMonitoring().getLoadUnits();						// Read default value from schema.
	...
	/**
	 * Task tree input interface getter. Useful for task generators and other animals who modify
	 * the tree.
	 * 
	 ...
	 * @throws RemoteException If something failed during this operation.
	 */
	String newContext(String name, String description, Serializable magicObject)
	 ...
	 * @throws RemoteException If something failed during this operation.
	 */
	void newContext(String id, String name, String description, Serializable magicObject)
	throws RemoteException;
	 ...
	 * @param description Human readable description of context.
	 * @param magicObject Some magic object (Serializable and Cloneable).
	 * @param selfCleaning Whether context should limit count of finished tasks in it automatically
	 * @throws RemoteException If something failed during this operation.
	 */
	void newContext(String id, String name, String description, Serializable magicObject, boolean selfCleaning)
	throws RemoteException;
	 ...
	 * 
	 * @param address Address of the task in the semantic tree.
	 * @throws RemoteException When it rains.
	 * @throws IllegalAddressException When the address does not exist or leads to a node.
	 */
	void killTaskByAddress(TaskTreeAddress address)
	 ...
	 * 
	 * @param address Address of the node in the semantic tree.
	 * @throws RemoteException When it rains.
	 * @throws IllegalAddressException When the address does not exist.
	 */
	void killNodeByAddress(TaskTreeAddress address)
	throws RemoteException, IllegalAddressException;
	 ...
	 * @throws RemoteException When it rains.
	 */
	void deleteNodeByAddress(TaskTreeAddress address)
	throws RemoteException, IllegalAddressException;
	 ...
	 * @param address Address of the task in the semantic tree.
	 * @throws RemoteException When it rains.
	 * @throws IllegalAddressException When he address does not exist.
	 */
	void deleteTaskByAddress(TaskTreeAddress address)
	throws RemoteException, IllegalAddressException;
	 ...
	 */
	Serializable checkPointLook(String name, String taskId, String contextId, long timeout)
	 ...
	 * @throws RemoteException When it rains.
	 * @throws LogStorageException If an error occured while retrieving the logs.
	 * @throws IllegalAddressException When the address does not exist or points to a node.
	 */
	LogRecord[] getLogsForTask(TaskTreeAddress address)
	 ...
	 * 
	 * @param address Address of the task in the semantic tree.
	 * @param first Index of the first log message.
	 * @param last Index of the last log message.
	 * @return Log records for the task.
	 * @throws RemoteException When it rains.
	 * @throws LogStorageException If an error occured while retrieving the logs.
	 * @throws IllegalAddressException When the address does not exist or points to a node.
	...
	/**
	 * Returns the number of log messages stored for a task. The task must have been registered
	 ...
	 * @throws IllegalAddressException When the address does not exist or points to a node.
	 */
	long getLogCountForTask(TaskTreeAddress address)
	throws RemoteException, LogStorageException, IllegalAddressException;
	 ...
	 * @throws IllegalAddressException When the address does not exist or points to a node.
	 */	
	boolean isTaskRegistered(TaskTreeAddress address)
	throws RemoteException, LogStorageException, IllegalAddressException;
	 ...
	 * @param listener instance to the listener
	 * @throws NullPointerException if the listener is <code>null</code>
	 * @throws RemoteException if something failed during the execution of
	 *          the remote method call.
	 */
