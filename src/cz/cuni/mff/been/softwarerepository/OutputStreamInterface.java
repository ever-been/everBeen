...
/**
 * A simple interface for output stream transporters that completely hides RMIIO.
 * 
 * @author Andrej Podzimek
 */
public interface OutputStreamInterface extends Serializable {

	/**
	 * Output stream getter.
	 * 
	 * @return An output stream which points at the remote stream server.
