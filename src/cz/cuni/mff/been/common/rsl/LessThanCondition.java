 ...
 * @author David Majda
 */
public class LessThanCondition< T > extends CompareCondition<T> {

	private static final long	serialVersionUID	= -391096927998389629L;
	 ...
	 */
	public LessThanCondition(String propertyPath, T value) {
