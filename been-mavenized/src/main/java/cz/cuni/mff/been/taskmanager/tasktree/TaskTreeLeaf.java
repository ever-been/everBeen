...
final class TaskTreeLeaf extends TaskTreeBasic {
	 ...
	 * 
	 * @param tree The task tree this leaf belongs to.
	 * @param address Address of the leaf.
	 * @param parentAddress Address of the parent node of this leaf.
	 * @param entry The task entry this leaf will store.
	 */
	TaskTreeLeaf(
		TaskTree tree,
