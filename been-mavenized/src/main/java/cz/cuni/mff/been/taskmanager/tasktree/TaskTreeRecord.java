...
/**
 * A simple class for traversing the tree of tasks efficiently. This avoids the necessity
 * to invoke two remote calls per node to find out the node type and get the value it stores.
 * That brings pain and synchronization problems.
 * 
...
public final class TaskTreeRecord implements Serializable {
	...
	/** Children of an element this record conveys when referring to a NODE element. */
	 ...
	 * 
	 * @param segments Tree path segments.
	 * @param task The task this triplet will store, possibly null,
	 * @param flags The array of flags and their values.
	 */
	TaskTreeRecord(
		String[] segments,
		TaskEntry task,
	 ...
	 * 
	 * @param segments Tree path segments.
	 * @param children The array of children this tripplet will store, possibly null.
	 * @param flags The array of flags and their values.
	 */
	TaskTreeRecord(
		String[] segments,
		TaskTreeAddress[] children,
		Pair< TaskTreeFlag, TreeFlagValue >[] flags
	) {
		this.segments = segments;
		this.type = Type.NODE;
	 ...
	 * @param flags The array of flags and their values.
	 */
	TaskTreeRecord( TaskTreeAddress[] children, Pair< TaskTreeFlag, TreeFlagValue >[] flags ) {
		this.segments = null;
		this.type = Type.NODE;
		this.task = null;
		this.children = children;
	 ...
	 * Task getter.
	 * 
	 * @return The task entry from a LEAF element, returns null on NODE elements.
	 */
	 ...
	 * Children getter.
	 * 
	 * @return The array of children from a NODE element, returns null on LEAF elements.
	 */
