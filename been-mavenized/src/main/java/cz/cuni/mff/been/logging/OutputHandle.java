 ...
 */
public interface OutputHandle extends Remote {
	/**
	 * 
	 ...
	 */
	String[] getNextLines(int count) throws RemoteException, IOException;
	 ...
	 * @throws IOException if an I/O error occured during the reading of the output.
	 */
	void skipLines(long count) throws RemoteException, IOException;
	 ...
	 * @throws IOException
	 */
	long getLineCount() throws RemoteException, IOException;
}
