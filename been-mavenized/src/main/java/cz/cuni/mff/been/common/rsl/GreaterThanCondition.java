 ...
 * @author David Majda
 */
public class GreaterThanCondition<T> extends CompareCondition<T> {

	private static final long	serialVersionUID	= 970914417975280694L;

	/**
	 * Allocates a new <code>GreaterThanCondition</code> object.
	 * 
	 * @param propertyPath property path
	 * @param value value to compare
	 */
	public GreaterThanCondition(String propertyPath, T value) {
