...
/**
 * Data handle referencing directly accessible long data.
 * 
 * @author Jan Tattermusch
 *
 */
public class LongDataHandle extends DataHandle {

	private static final long serialVersionUID = -5773408946473191702L;
	private Long data;
	
	public LongDataHandle(long data) {
		this.data = data;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LongDataHandle other = (LongDataHandle) obj;
		if (data == null) {
			if (other.data != null)
				return false;
