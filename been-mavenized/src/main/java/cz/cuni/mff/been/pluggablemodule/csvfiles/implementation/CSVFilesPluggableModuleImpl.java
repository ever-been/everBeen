...
/**
 * Pluggable module for working with CSV files implementation.
 * @author Jan Tattermusch
 *
 */
public class CSVFilesPluggableModuleImpl extends PluggableModule implements CSVFilesPluggableModule{

    /**
     * Creates new instance of pluggable module
     * @param manager pluggable module manager
     */
	public CSVFilesPluggableModuleImpl(PluggableModuleManager manager) {
		super(manager);
	}
     ...
     */
	@Override
	public ResultRepositoryCSVUtils createResultsRepositoryCSVUtils(
			FileStoreClient fileStoreClient, File fileUploadDownloadDir,
			char separatorChar, char quoteChar) {
		
		return new ResultRepositoryCSVUtilsImpl(fileStoreClient, fileUploadDownloadDir, separatorChar, quoteChar);
	}
