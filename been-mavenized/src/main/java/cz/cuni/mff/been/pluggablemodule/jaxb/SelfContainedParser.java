 ...
 */
public final class SelfContainedParser implements BindingParser< PluggableModuleConfiguration > {
	...
	/**
	 * Createse a new JAXB-based parser bound to the pluggable module configuration schema.
	 * 
	 * @throws JAXBException When unmarshaller initialization fails.
	 */
	...
	@Override
	public PluggableModuleConfiguration parse( InputStream stream ) throws JAXBException {
	...
	@Override
	public PluggableModuleConfiguration parse( Reader reader ) throws JAXBException {
	...
	static {
		...
		try {
			context = JAXBContext.newInstance( PluggableModuleConfiguration.class );
			...
			throw new ExceptionInInitializerError( exception );										// Dirty, but needed.
