...
public interface ServiceControlInterface extends Remote {
	 ...
	 */
	void stopService() throws RemoteException, InvalidServiceStateException,
			TaskException;
	...
	/**
	 * Does nothing, but it can be used to test whether a remote reference is
	 * valid (that is whether it still references a valid remote object).
	 * 
	 * @throws RemoteException
	 */
