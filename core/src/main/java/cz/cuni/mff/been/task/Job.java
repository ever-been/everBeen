 ...
 */
public abstract class Job extends AbstractTask {
	 ...
	 *             if the Job failed to do its work.
	 */
	protected abstract void run() throws TaskException;

	/**
	 * Checks required job properties, starts job afterwards. When the work is
	 * done exits the JVM
	 * 
	...
	/**
	 * Checks if all properties from <code>requiredProperties</code> are set
	 * (not <code>null</code>)
	 * 
	 * @param requiredProperties
	 *            list of properties to check
	 * @throws TaskException
	 *             when any of required properties is not set
	 */
	protected void checkRequiredProperties(String[] requiredProperties)
			throws TaskException {
	 ...
	 * 
	 * @throws TaskException
	 *             if the property is not present (set to null).
	 */
	...
	/**
	 * Checks if all required properties are present. This method is called
	 * automatically before the Job is started and has to be implemented by the
	 * Job.
	 * 
	 * @throws TaskException
	 *             if some of the required properties are not set. All
	 *             properties are reported in one go in the message.
	 */
