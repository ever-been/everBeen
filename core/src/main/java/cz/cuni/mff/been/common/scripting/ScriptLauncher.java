...
public class ScriptLauncher {
	 ...
	 * @param scriptFile	file to run
	 * @param environment  script's environment
	 * @return script's exitcode
	 * @throws ScriptException
	 */
	public int runShellScript(File scriptFile,
	 ...
	 * @param script lines of script to run
	 * @param environment  script's environment
	 * @return script's exitcode
	 * @throws ScriptException
	 */
	
	public int runShellScript(String[] script,
			ScriptEnvironment environment) throws ScriptException {
	 ...
	 * 
	 * Tries to detect whether running on windows and if so,
	 * adds .bat to file name
	 * 
	...
	private File makeTempScriptFile(String[] script) throws IOException {
		...
		if (Task.getTaskHandle() != null) {
			if (Task.getTaskHandle().isRunningInWindows()) {
				tmpFileName += ".bat";
			}
		}
