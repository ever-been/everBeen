...
public abstract class AbstractTask implements Task {
	 ...
	 * content
	 */
	private final String taskDirectory = System.getProperty(Task.PROP_DIR_TASK);
	/**
	...
	private final String workingDirectory = System
			.getProperty(Task.PROP_DIR_WORK);
	/**
	 * Temporary directory for this task specified by Host Runtime, it IS
	 * deleted immediately after task's end
	 */
	private final String tempDirectory = System.getProperty(Task.PROP_DIR_TEMP);
