...
/**
 * This is a small adapter that splits the read and write access to the task
 * tree. It implements {@link TaskTreeQuery} and relays all the calls so that
 * this implementation cannot be cast to the reading interface.
 * 
...
public final class TaskTreeReader implements TaskTreeQuery, Serializable {
	 ...
	 * 
	 * @param query
	 *            The query interface to read from.
	 */
	...
	@Override
	public String[] getPathAt(TaskTreeAddress address) throws RemoteException {
	...
	public TreeFlagValue getFlagValueAt(
			TaskTreeAddress address,
			TaskTreeFlag flag) throws IllegalAddressException, RemoteException {
