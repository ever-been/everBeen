...
public class XamplerCollectResults extends Job {
	...
	protected void checkRequiredProperties() throws TaskException {
		checkRequiredProperties(new String[] { RESULTS_ANALYSIS_NAME,
				RESULTS_DATASET_NAME, XAMPLER_REVISION, OMNIORB_TIMESTAMP,
				BUILD_NUMBER, RUN_NUMBER, SUITE_NAME, RESULTS_DIR });
		...
		try {
			...
			throw new TaskException("Error parsing \"" + RUN_NUMBER
					+ "\" property");
		}
