...
/**
 * A command line interface component that corresponds to the benchmarks listing screen.
 * 
...
public final class BenchmarksModule extends CommandLineModule {
	...
	public enum Errors implements Message {
		...
		INVD_CONFIG( "Errors in configuration of the generator and/or evaluator(s)." ),
	...
	static {
		...
		actions.put(
			...
			new CommandLineAction< BenchmarksModule >() {
				...
				public void handle(
					...
					try {
						if ( null == pattern ) {
							generators = module.benchmarkManagerAdapter.getGenerators();
						} else {
							generators = module.benchmarkManagerAdapter.getGenerators(
		...
		actions.put(
			"generator-dump",
			new CommandLineAction< BenchmarksModule >() {
				private final Set< String > parameters = stringSet( "name", "version" );
				private final Set< String > flags = stringSet();
				...
				public void handle(
					...
					try {
						config = module.benchmarkManagerAdapter.getGeneratorConfig(
		...
		actions.put(
			...
			new CommandLineAction< BenchmarksModule >() {
				...
				public void handle(
					...
					try {
						if ( null == pattern ) {
							evaluators = module.benchmarkManagerAdapter.getEvaluators();
						} else {
							evaluators = module.benchmarkManagerAdapter.getEvaluators(
								Pattern.compile( pattern )
							);
		...
		actions.put(
			...
			new CommandLineAction< BenchmarksModule >() {
				...
				public void handle(
					...
					try {
						config = module.benchmarkManagerAdapter.getEvaluatorConfig(
							request.getParameter( "name" ),
							request.getParameter( "version" )
						);
					} catch ( BenchmarkManagerException exception ) {
		...
		actions.put(
			...
			new CommandLineAction< BenchmarksModule >() {
				...
				public void handle(
					...
					try {
						if ( null == pattern ) {
							analyses = module.benchmarkManagerAdapter.getRawAnalyses();
						} else {
							analyses = module.benchmarkManagerAdapter.getAnalyses(
								Pattern.compile( pattern )
							);
						}
					} catch ( PatternSyntaxException exception ) {
		...
		actions.put(
			...
			new CommandLineAction< BenchmarksModule >() {
				...
				public void handle(
					...
					try {
						benchmark = module.benchmarkManagerAdapter.getAnalysis(
							request.getParameter( "name" )
						);
					} catch ( BenchmarkManagerException exception ) {
						throw new ModuleSpecificException( Errors.FAIL_BM, exception );
		...
		actions.put(
			...
			new CommandLineAction< BenchmarksModule >() {
				...
				public void handle(
					...
					try {
						benchmark = module.benchmarkParser.parse( request.getBlobStream() );
						module.benchmarkManagerAdapter.createAnalysis( benchmark );
						...
						throw new ModuleSpecificException( Errors.MALF_ANAL, exception );
					} catch ( BenchmarkManagerException exception ) {
						throw new ModuleSpecificException( Errors.FAIL_BM, exception );
					} catch ( ComponentInitializationException exception ) {
						throw new ModuleSpecificException( Errors.CONN_BM, exception );
		...
		actions.put(
			...
			new CommandLineAction< BenchmarksModule >() {
				...
				public void handle(
					...
					try {
						benchmark = module.benchmarkParser.parse( request.getBlobStream() );
						module.benchmarkManagerAdapter.updateAnalysis( benchmark );
					} catch ( UnmarshalException exception ) {
						throw new ModuleSpecificException( Errors.FAIL_UMSL_VAL, exception );
					} catch ( JAXBException exception ) {
						throw new ModuleSpecificException( Errors.FAIL_UMSL, exception );
	...
	public BenchmarksModule() throws CommandLineException {
		...
		try {
			this.benchmarkComposer = XSD.BENCHMARK.createComposer( Benchmark.class );
