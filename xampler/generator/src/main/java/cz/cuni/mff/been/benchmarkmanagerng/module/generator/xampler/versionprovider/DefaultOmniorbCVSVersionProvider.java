 ...
 * 
 * This class get the version list from Cvs.rlog task. cvs rlog is invoked on
 * update.log file (this file is always changed with omniORB commit).
 * 
...
public class DefaultOmniorbCVSVersionProvider {
	 ...
	 * 
	 * Update log is a file in omniorb's repository root that contains information
	 * about omniorb changes. Update log is analyzed instead of CVS history
	 * because it's hard to extract a commit log of a specific branch from CVS.
	 * 
	 * This is how method works: 1. omniorb's root is checked out (with
	 * non-recursive option) 2. update log file is loaded and analyzed 3. list of
	 * versions is returned
	 * 
	 * @param repository
	 *          CVS repository URL
	 * @param password
	 *          CVS repostory password
	 * @param cvsRsh
	 *          CVS rsh
	 * @param module
	 *          CVS module
	 ...
	 *          CVS tag (branch)
	 * @param fromDate
	 *          retrieve only versions newer than this date
	 * @return set of versions available in CVS
	 * @throws AnalysisException
	 */
	public Set<SourceKey> getAvailableVersions(String repository,
			String password, String cvsRsh, String module, String tag, Date fromDate) throws AnalysisException {
	 ...
	 *          cvs log contents
	 * @param dateFrom
	 *          return only versions new than this date
	 * @return return set of source versions
	 * @throws AnalysisException
	 */
	private SortedSet<SourceKey> findVersionTimestamps(List<String> log,
			Date dateFrom) throws AnalysisException {
	 ...
	 * @throws IOException
	 */
	private String getCvsRLog(String repository, String password, String cvsRsh,
			String module, String tag) throws IOException {
