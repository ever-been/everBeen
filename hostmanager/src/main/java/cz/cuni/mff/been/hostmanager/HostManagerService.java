...
import static cz.cuni.mff.been.services.Names.HOST_MANAGER_REMOTE_INTERFACE_DATABASE;
import static cz.cuni.mff.been.services.Names.HOST_MANAGER_REMOTE_INTERFACE_MAIN;
import static cz.cuni.mff.been.services.Names.HOST_MANAGER_REMOTE_INTERFACE_LOAD_SERVER;
...
public class HostManagerService extends Service {
	...
	public String getName() {
		...
		return HOST_MANAGER_SERVICE_NAME;
	}
	...
	protected void start() throws TaskException {
		...
		addRemoteInterface(HOST_MANAGER_REMOTE_INTERFACE_DATABASE, hostManager);
		addRemoteInterface(HOST_MANAGER_REMOTE_INTERFACE_MAIN, hostManager);
		addRemoteInterface(HOST_MANAGER_REMOTE_INTERFACE_LOAD_SERVER, loadServer);
